...
pub fn init_logs() {
    ...
    let file_layer = tracing_subscriber::fmt::Layer::new()
        ...
        .with_filter(tracing_subscriber::filter::EnvFilter::new(
            "info,toolchanger_utils=trace,eframe=warn,wgpu=warn",
        ));
    ...
    let stderr_layer = tracing_subscriber::fmt::layer()
        ...
        .compact()
        .with_filter(tracing_subscriber::filter::EnvFilter::new(
            // "info,toolchanger_utils=debug,eframe=warn,wgpu=warn",
            "warn,toolchanger_utils=debug,eframe=warn,wgpu=warn",
        ));
